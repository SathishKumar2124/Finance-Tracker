...
const Login = () => {
  return (
    <div className='mt-20 flex flex-col justify-center items-center'>
        ...
        <h1 className='text-2xl text-center font-extrabold mb-4'>Login</h1>
        ...
        <div className='flex items-center justify-center'> 
            <p className=''>don't have an account ? <a className='text-blue-700 underline ' href='/signup'>signup</a> </p>
          </div>
